...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shirFilter(SecurityManager securityManager){
        ...
        List<CsPermission> resourcesList = perService.queryAll();
         for(CsPermission resources:resourcesList){
            ...
            if (CustomUtil.isNotEmpty(resources.getUrl())) {
    ...
    public CustomShiroRealm myShiroRealm(){
    	CustomShiroRealm csr = new CustomShiroRealm();
    	csr.setCredentialsMatcher(hashedCredentialsMatcher());
        return csr;
    }
